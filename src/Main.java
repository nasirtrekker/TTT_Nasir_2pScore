 ...
 * 				AI vs Human and AI vs AI implementation with a GUI is under construction
...
public class Main
{
    ...
    public static void main(String[]args) throws IOException
    {
        ...
        System.out.println();
        System.out.println("To play in a square, please simply enter the corresponding cell (eg. 1, 2,3, 4,.....");
        ...
        System.out.println("Please enter Player Names and Symbols");
        System.out.println();
        //Player1
